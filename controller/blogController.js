...
const createBlog = asyncHandler(async (req, res) => {
    try {
        ...
        console.log("Error in Blog 1 controller");
...
const updateBlog = asyncHandler(async (req, res) => {
    const { id } = req.params;
    try {
        const udpateBlog = await Blog.findByIdAndUpdate(id, req.body, {
            new: true,
        });
        res.json(udpateBlog);
    } catch (error) {
        console.log("Error in Blog 2  controller");
        throw new Error(error);
    }
});
...
const getBlog = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        console.log("Error in Blog 3  controller");
        throw new Error(error);
    }
});
...
const getAllBlogs = asyncHandler(async (req, res) => {
    try {
        ...
        console.log("Error in Blog  4 controller");
        throw new Error(error);
    }
});
const deleteBlog = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        console.log("Error in Blog 5  controller");
        throw new Error(error);
    }
});
